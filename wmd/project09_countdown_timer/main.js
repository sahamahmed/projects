...
async function Timer(TimeEntry) {
    ...
    const destinedTime = new Date(currentDate.getFullYear(), currentDate.getMonth(), currentDate.getDate(), DestinedHr, DestinedMin, DestinedSec);
